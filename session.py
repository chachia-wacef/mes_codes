...
# HTTPAdapter & Retry : J'ai ajouté un petit bonus (HTTPAdapter). 
# Cela permet à la session de gérer elle-même les micro-coupures réseau ou les erreurs 502/503 
# sans que votre code ne plante. Il réessaiera 3 fois automatiquement avant d'abandonner le lot.
